...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kRearRightDrivingCanId = 58;

    public static final int kFrontLeftTurningCanId = 59;
    public static final int kRearLeftTurningCanId = 55;
    public static final int kFrontRightTurningCanId = 61;
    public static final int kRearRightTurningCanId = 57;
